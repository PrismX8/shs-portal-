...
(function() {
    ...
    function checkV86Version() {
        ...
        // If no stored version exists (first run), update it and return true
        if (!storedVersion) {
            updateV86Version();
            console.log(`V86 first run - version set to ${CURRENT_V86_VERSION}`);
            return true;
        }

        if (storedVersion !== CURRENT_V86_VERSION) {
